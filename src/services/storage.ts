...
const KEYS = {
  USERS: 'oson_users_v1',
  CURRENT_USER: 'oson_current_user_v1',
  VERIFICATIONS: 'oson_verifications_v1',
  LEVELS: 'oson_levels_v1',
  COURSES: 'oson_courses_v1',
  TOPICS: 'oson_topics_v1',
  LESSONS: 'oson_lessons_v1',
  WORDS: 'oson_words_v1',
  QUESTIONS: 'oson_questions_v1',
  QUIZZES: 'oson_quizzes_v1',
  QUIZ_ATTEMPTS: 'oson_quiz_attempts_v1',
  SPEAKING_ATTEMPTS: 'oson_speaking_attempts_v1',
  CONVERSATIONS: 'oson_conversations_v1',
  XP_TRANSACTIONS: 'oson_xp_transactions_v1',
  ACHIEVEMENTS: 'oson_achievements_v1',
  USER_ACHIEVEMENTS: 'oson_user_achievements_v1',
  STREAKS: 'oson_streaks_v1',
  LOCATIONS: 'oson_locations_v1',
  DOCTOR_PROFILES: 'oson_doctor_profiles_v1',
  DOCTOR_NOTES: 'oson_doctor_notes_v1',
  DAILY_CHALLENGES: 'oson_daily_challenges_v1',
  SRS_PROGRESS: 'oson_srs_progress_v1',
};
